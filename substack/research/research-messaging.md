...
description: Research workflow for messaging consistency content ideas. Orchestrates Perplexity → Gemini → Notion pipeline for The Narrative Pivot.
disable-model-invocation: true
---

# Research Workflow: Messaging Consistency

This workflow generates validated, differentiated content ideas on **messaging consistency across the brand** for B2B SaaS founders and business leaders.
...
Research topic: MESSAGING CONSISTENCY ACROSS THE BRAND
...
1. FOUNDER AND TEAM LEADER PAIN POINTS
   What are practitioners currently struggling with related to messaging consistency?
   What symptoms do they name (e.g., "sales explains the product differently than marketing," "our deck doesn't match our website," "every team has a different elevator pitch")?
...
2. EXISTING POSITIONING AND MESSAGING CONTENT
   What have these product marketing creators published on messaging consistency in the last 6-12 months:
   ...
   For each creator:
   - Summarize their core arguments and angles on messaging consistency
   ...
   Focus only on positioning/messaging content, not general marketing advice.

3. PATTERNS, GAPS, AND MISCONCEPTIONS
   - What conventional wisdom keeps showing up around messaging consistency?
   - What misconceptions or confusion recurs in practitioner discussions?
   - What emotionally loaded language or repeated phrases appear? (e.g., "everyone's saying something different," "no one's aligned")
...
- Would describe their problem as: "our sales cycle is too long", "different teams explain the product differently", "we're losing deals we should be winning", "our messaging feels inconsistent"
- Would NOT describe their problem as: "we need better positioning" (they don't know that's the issue yet)

Below is research from Perplexity on MESSAGING CONSISTENCY:
...
1. COMPETITIVE SYNTHESIS
   ...
   - What have April Dunford, FletchPMM, MKT1, Rory Woodbridge, and Peep Laja already covered thoroughly on messaging consistency?
...
2. GAP ANALYSIS
   ...
   - Where is there an opportunity to invert or reframe conventional wisdom about messaging consistency?
   - What misconceptions could be challenged?
   - What practitioner pain points are being ignored by PMM creators?

3. IDEA CLUSTERING
   Generate 7-10 distinct post ideas on messaging consistency. For each idea, provide:
   ...
   **Idea [#]: [Working title - punchy, declarative, makes the reader feel called out]**
   ...
   - **Core thesis (one sentence):** The inversion or reframe. NOT a summary.
     ...
     Strong thesis example: "You don't have inconsistent messaging. You have too many decision makers."
     Weak thesis example: "Consistent messaging requires alignment across teams."
   ...
   - **Competitive gap identified:** Why would this post exist if April Dunford, FletchPMM, or MKT1 already write about messaging consistency? Be specific.
   ...
   - **What the reader walks away able to DO:** One specific, immediate action they can take (not "audit your messaging" - too vague).
...
CRITICAL FILTERS:
- Do NOT generate listicles or "X ways to improve messaging consistency" ideas
...
- **After publishing a post:** Check if the competitive landscape shifted based on what you just published
...
A pipeline of 7-10 validated, differentiated content ideas on messaging consistency, ready to develop into full posts through the Claude workflow (Stages 3-8).
